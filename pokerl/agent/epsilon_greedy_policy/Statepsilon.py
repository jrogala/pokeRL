...
@dataclass
class Epsilon():
    epsilon: float = field(init=True, repr=True, default=.5)
    epsilon_decay: float = field(init=True, repr=True, default=.99)
    epsilon_min: float = field(init=True, repr=True, default=.01)
